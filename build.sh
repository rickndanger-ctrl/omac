...
/usr/bin/codesign --force --sign "${OMAC_SIGN_IDENTITY:--}" branding/screensaver/build/OMAC.saver
/usr/bin/codesign --force --sign "${OMAC_SIGN_IDENTITY:--}" branding/screensaver/build/OMAC-Preview.app
